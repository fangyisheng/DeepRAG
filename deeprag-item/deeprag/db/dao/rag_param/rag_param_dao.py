...
class RagParamDAO:
    ...
    async def create_rag_param(self, id: str, grounds_for_response: str, message_id: str):
    ...
    async def get_rag_param_by_message_id(self, message_id:str):
        await self.db.connect()
        rag_param = await self.db.rag_param.find_unique(where={"message_id":message_id})
        await self.db.disconnect()
        return rag_param
