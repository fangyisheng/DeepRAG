...
embedding_model_input_string_array_length = int(os.getenv("EMBEDDING_MODEL_INPUT_STRING_ARRAY_LENGTH"))

max_rate = min(embedding_model_rps, embedding_model_rps*embedding_model_input_string_array_length
               *embedding_model_max_token//embedding_model_tpm)
#计算得到模型每分钟的最大速率
